    ...
    <span ref={box} className="relative inline-block align-baseline">
      ...
      {open ? (
        <span
          id={id}
          role="note"
          className="absolute start-0 top-[calc(100%+6px)] z-20 block w-[248px] max-w-[76vw] rounded-lg border border-kashi/25 bg-kaghaz-lift p-3 font-latin text-[14px] font-normal normal-case not-italic leading-relaxed tracking-normal text-ink shadow-paper"
        >
          {children}
        </span>
      ) : null}
